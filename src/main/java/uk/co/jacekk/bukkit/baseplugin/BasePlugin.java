...
public abstract class BasePlugin extends JavaPlugin
{
	...
	// The PluginDescriptionFile for this plugin.
	public PluginDescriptionFile description;
	
	// The PluginLogger for this plugin.
	...
	// createFolder: If this is true then the plugin's data folder will be created if it does not exist.
